    ...
    def __init__(self, *exprs):
        ...
        if len(exprs) == 0:
            ...
            if exprs[-1] is not None:
                ...
                self.exprs = torch.nn.ModuleList([to_expr(e) for e in exprs[:-1]])
...
class Variable(Expression):
    ...
    def __init__(
        ...
        *size_or_tensor,
        ...
        Args:
            *size_or_tensor: Size specification or tensor.
    ...
    def value(self, val: torch.Tensor):
        ...
        Examples:
            ...
            torch.Size([5])
        """
        requires_grad = self.value.requires_grad if hasattr(self, self._name) else True
