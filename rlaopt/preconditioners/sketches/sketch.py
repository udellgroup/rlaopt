...
class Sketch(ABC):
    ...
    def _apply_left(self, x: Union[torch.Tensor, LinOp]) -> torch.Tensor:
        return self.Smat @ x

    def _apply_right(self, x: Union[torch.Tensor, LinOp]) -> torch.Tensor:
        return x @ self.Smat

    def _apply_left_trans(self, x: Union[torch.Tensor, LinOp]) -> torch.Tensor:
        return self.Smat.T @ x

    def _apply_right_trans(self, x: Union[torch.Tensor, LinOp]) -> torch.Tensor:
